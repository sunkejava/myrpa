...
type TaskRow = { id: string; name: string; status: string; total: number; succeeded: number; failed: number; progress: number }
...
<template>
  <section class="panel">
    ...
    <div class="table-wrap">
      <table>
        <thead><tr><th>任务</th><th>进度</th><th>成功 / 总数</th><th>失败</th><th>状态</th></tr></thead>
        <tbody>
