export const zh = {
  title: 'Workflow 管理', help: '选择已有流程编辑版本与风险，发布后才能创建任务。', add: '新增 Workflow', create: '创建 Workflow',
  city: '城市', chooseCity: '选择城市', system: '系统', chooseSystem: '选择系统', function: '功能', chooseFunction: '选择功能',
  name: '名称', description: '说明', existing: '已有 Workflow', chooseWorkflow: '选择 Workflow', history: '历史版本', chooseVersion: '选择版本查看与编辑',
  published: '已发布', draft: '草稿', risk: '风险级别', riskAria: 'Workflow 风险级别', approval: '审批门禁', autoApproval: '按风险级别自动判定', mustApprove: '必须审批',
  definition: '定义与风险', addStep: '添加步骤', steps: '步骤', unnamed: '未命名', unknown: '未知', none: '无',
...
export const en = {
  ...
  city: 'City', chooseCity: 'Select city', system: 'System', chooseSystem: 'Select system', function: 'Function', chooseFunction: 'Select function',
  name: 'Name', description: 'Description', existing: 'Existing workflows', chooseWorkflow: 'Select workflow', history: 'Previous versions', chooseVersion: 'Select a version to edit',
  published: 'Published', draft: 'Draft', risk: 'Risk level', riskAria: 'Workflow risk level', approval: 'Approval gate', autoApproval: 'Decide by risk level', mustApprove: 'Always require approval',
  definition: 'Definition and risk', addStep: 'Add step', steps: 'Steps', unnamed: 'Unnamed', unknown: 'Unknown', none: 'None',
