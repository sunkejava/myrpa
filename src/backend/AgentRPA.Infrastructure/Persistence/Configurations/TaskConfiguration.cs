...
{
    public void Configure(EntityTypeBuilder<RpaTask> b) { b.ToTable("tasks"); b.HasKey(x => x.Id); b.Property(x => x.Name).HasMaxLength(200).IsRequired(); b.HasIndex(x => x.Status); }
